...
union all select 1,@BatchID,'Source.EXCEL.FilePath','<Test.File>'			
union all select 1,@BatchID,'Source.EXCEL.Header','1'			
union all select 1,@BatchID,'Source.EXCEL.ExcelVersion','Microsoft Excel 2016'			
...
union all select 1,@BatchID,'Destination.EXCEL.FilePath','<Test.File>'			
union all select 1,@BatchID,'Destination.EXCEL.Header','1'			
union all select 1,@BatchID,'Destination.EXCEL.ExcelVersion','Microsoft Excel 2016'			
