...
GO
ALTER TABLE [dbo].[SystemParameters] DROP CONSTRAINT [DF__SystemPar__LastM__49C3F6B7];
...
GO
ALTER TABLE [dbo].[SystemParameters] DROP CONSTRAINT [DF__SystemPar__LastM__4AB81AF0];
...
GO
PRINT N'Altering [dbo].[fn_SystemParameter]...';
...
ALTER FUNCTION [dbo].[fn_SystemParameter] (
    ...
    END
GO
PRINT N'Altering [dbo].[prc_SystemParameterSet]...';


GO

ALTER PROCEDURE [dbo].[prc_SystemParameterSet] (
...
RETURN @Err
GO
PRINT N'Altering [dbo].[prc_SystemParameterLet]...';


GO

ALTER PROCEDURE [dbo].[prc_SystemParameterLet] (
