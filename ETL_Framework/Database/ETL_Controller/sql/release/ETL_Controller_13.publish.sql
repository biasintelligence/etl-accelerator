...
GO
PRINT N'Dropping unnamed constraint on [dbo].[SystemParameters]...';


GO
ALTER TABLE [dbo].[SystemParameters] DROP CONSTRAINT [DF__SystemPar__LastM__6EF57B66];
...
GO
ALTER TABLE [dbo].[SystemParameters] DROP CONSTRAINT [DF__SystemPar__LastM__6FE99F9F];
...
GO
PRINT N'Dropping [dbo].[prc_ConstraintCheck]...';


GO
DROP PROCEDURE [dbo].[prc_ConstraintCheck];


GO
PRINT N'Dropping [dbo].[prc_de_CreateParameters]...';


GO
DROP PROCEDURE [dbo].[prc_de_CreateParameters];


GO
PRINT N'Dropping [dbo].[prc_PersistContext]...';


GO
DROP PROCEDURE [dbo].[prc_PersistContext];


GO
PRINT N'Dropping [dbo].[prc_DE_MapAttributes]...';


GO
DROP PROCEDURE [dbo].[prc_DE_MapAttributes];


GO
PRINT N'Dropping [dbo].[prc_CreateContext]...';


GO
DROP PROCEDURE [dbo].[prc_CreateContext];


GO
PRINT N'Dropping [dbo].[prc_Finalize]...';


GO
DROP PROCEDURE [dbo].[prc_Finalize];


GO
PRINT N'Dropping [dbo].[prc_CounterGet]...';


GO
DROP PROCEDURE [dbo].[prc_CounterGet];


GO
PRINT N'Dropping [dbo].[prc_ReadProcessReceipt]...';


GO
DROP PROCEDURE [dbo].[prc_ReadProcessReceipt];


GO
PRINT N'Dropping [dbo].[prc_CreateHeader]...';


GO
DROP PROCEDURE [dbo].[prc_CreateHeader];


GO
PRINT N'Dropping [dbo].[prc_CreateProcessReceipt]...';


GO
DROP PROCEDURE [dbo].[prc_CreateProcessReceipt];


GO
PRINT N'Dropping [dbo].[prc_CreateProcessRequest]...';


GO
DROP PROCEDURE [dbo].[prc_CreateProcessRequest];


GO
PRINT N'Dropping [dbo].[prc_ReadAttribute]...';


GO
DROP PROCEDURE [dbo].[prc_ReadAttribute];


GO
PRINT N'Dropping [dbo].[prc_AttributeGet]...';


GO
DROP PROCEDURE [dbo].[prc_AttributeGet];


GO
PRINT N'Dropping [dbo].[prc_AttributeSet]...';


GO
DROP PROCEDURE [dbo].[prc_AttributeSet];


GO
PRINT N'Dropping [dbo].[prc_CounterSet]...';


GO
DROP PROCEDURE [dbo].[prc_CounterSet];


GO
PRINT N'Dropping [dbo].[prc_ReadContextAttributes]...';


GO
DROP PROCEDURE [dbo].[prc_ReadContextAttributes];


GO
PRINT N'Dropping [dbo].[prc_ReadCounter]...';


GO
DROP PROCEDURE [dbo].[prc_ReadCounter];


GO
PRINT N'Dropping [dbo].[prc_CreateCounters]...';


GO
DROP PROCEDURE [dbo].[prc_CreateCounters];


GO
PRINT N'Dropping [dbo].[prc_ReadProcessRequest]...';


GO
DROP PROCEDURE [dbo].[prc_ReadProcessRequest];


GO
PRINT N'Dropping [dbo].[prc_CreateProcessInfo]...';


GO
DROP PROCEDURE [dbo].[prc_CreateProcessInfo];


GO
PRINT N'Dropping [dbo].[prc_Print]...';


GO
DROP PROCEDURE [dbo].[prc_Print];


GO
PRINT N'Dropping [dbo].[prc_ReadHeader]...';


GO
DROP PROCEDURE [dbo].[prc_ReadHeader];


GO
PRINT N'Dropping [dbo].[prc_ReadProcessInfo]...';


GO
DROP PROCEDURE [dbo].[prc_ReadProcessInfo];


GO
PRINT N'Dropping [dbo].[ETLController]...';


GO
DROP XML SCHEMA COLLECTION [dbo].[ETLController];
                      ...
                      <xsd:complexType>
                        <xsd:complexContent>
                          <xsd:restriction base="xsd:anyType">
                            ...
                            <xsd:attribute name="Timeout1" type="xsd:int" />
                          </xsd:restriction>
                        </xsd:complexContent>
                      </xsd:complexType>
                    </xsd:element>
...
GO
PRINT N'Refreshing [dbo].[prc_ApplicationLog]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[prc_ApplicationLog]';
