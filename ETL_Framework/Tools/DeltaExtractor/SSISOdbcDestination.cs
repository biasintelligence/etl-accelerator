...
namespace BIAS.Framework.DeltaExtractor
{
    public class SSISOdbcDestination : SSISModule
    {
        ...
        public SSISOdbcDestination(OdbcDestination dbdst, MainPipe pipe, IDTSComponentMetaData100 src, int outputID, ConnectionManager cm)
            : base(pipe, "ODBC Destination", outputID)
        {
