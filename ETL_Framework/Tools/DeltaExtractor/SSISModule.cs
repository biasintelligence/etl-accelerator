...
namespace BIAS.Framework.DeltaExtractor
{
    public abstract class SSISModule
    {
        ...
        protected SSISModule(MainPipe pipe, string module_name, int module_id)
            : this(pipe, module_name, module_id, String.Empty)
        {
        }

        protected SSISModule(MainPipe pipe, string module_name)
            : this(pipe, module_name, 0)
        {
        }
