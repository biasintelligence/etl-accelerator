...
namespace BIAS.Framework.DeltaExtractor
{
    public class SSISSqlBulkDestination : SSISModule
    {
        ...
        public SSISSqlBulkDestination(SqlBulkDestination dbdst, MainPipe pipe, IDTSComponentMetaData100 src, int outputID, ConnectionManager cm)
            : base(pipe, "SQL Server Destination", outputID)
        {
